...
3.  **Transformação (Python):** Utilizei Python para automatizar a limpeza, calcular o volume de atraso por cliente e criar uma lógica de classificação de Score personalizada (Excelente, Alto, Médio e Crítico).
